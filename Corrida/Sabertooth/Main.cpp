...
int main() {
	...
	// run
	program.Run(program.coreShader, window, VAO1, VAOlight, objectsPositions, cubesPositions, meshs, objPoints);

	// finish
	program.Finish(VAO1, VAOlight);
